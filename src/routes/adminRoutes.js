...
const { getAllUser ,activateUser,deActivateUser,deleteUser,getAllActivateUser,getAllDeActivateUser} = require('../controllers/adminController');
...
router.get('/user/deactivate',authMiddleware.verifyAdmin, getAllDeActivateUser);

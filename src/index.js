...
const readymadePaperRoutes = require('./routes/readymadePaperRoutes');
const plannerRoutes = require('./routes/plannerRoutes');
const timeTableRoutes = require('./routes/timeTableRoutes');
const paperStyleRoutes = require('./routes/paperStyleRoutes');
...
app.use('/api/readymade-papers', readymadePaperRoutes);
app.use('/api/planners', plannerRoutes);
app.use('/api/timetables', timeTableRoutes);
app.use('/api/paper-styles', paperStyleRoutes);
